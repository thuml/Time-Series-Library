# SGTONet: A Shift-Aware Graph and Trigger-Oriented Network for Rare Degradation State Classification in Mine Hoisting Systems

**Anonymous digest manuscript**
...
**Table. Main label_shift=1 results. Mean values over three file-level splits.**
...
**Table. Mechanism ablation under label_shift=1.**
...
**Table. Horizon limitation. The current method is not a general multi-horizon solution.**
