...
def run_experiments():
    ...
    commands = [
        "python -u run.py --task_name long_term_forecast --is_training 1 --root_path ./dataset/yfinance/ --data_path TSMC.csv --model_id TSMC_30_7 --model DyVolFusion --use_norm 1 --data custom --features MS --target Target_Vol --seq_len 30 --label_len 15 --pred_len 7 --e_layers 2 --d_layers 1 --factor 3 --enc_in 5 --dec_in 5 --c_out 1 --d_model 128 --d_ff 256 --n_heads 4 --dropout 0.1 --loss MSE --patience 30 --des Exp --itr 1 --train_epochs 100 --batch_size 128 --learning_rate 0.00001"
    ]
