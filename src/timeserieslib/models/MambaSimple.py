...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.layers = nn.ModuleList([ResidualBlock(configs, self.d_inner, self.dt_rank)
...
class MambaBlock(nn.Module):
    ...
    def selective_scan(self, u, delta, A, B, C, D):
        ...
        # From a discussion with authors: "A is the more important term and the
        # performance doesn't change much with the simplification on B"
